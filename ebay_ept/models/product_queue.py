...
class SyncImportProductQueue(models.Model):
    ...
    instance_id = fields.Many2one(
        'ebay.instance.ept', string='Sites', help="Product imported from or Synced to this Ebay Site.")
    ...
    def create(self, vals):
        ...
        return super(SyncImportProductQueue, self).create(vals)

    def create_product_queue(self, instance, results, product_queue=False, is_create_odoo_product=False,
        ...
        for item in results:
            if not product_queue:
                product_queue = product_queue_line.ebay_create_product_queue(instance)
            ...
            val = product_queue_line.prepare_queue_line_vals(instance, item_id, data, product_queue,
