...
class EbayOrderDataQueueEpt(models.Model):
    ...
    ebay_order_common_log_lines_ids = fields.One2many(
        related="order_common_log_book_id.log_lines", help="Log lines of Common log book for particular order queue")
    ...
    def create(self, vals):
        ...
        return super(EbayOrderDataQueueEpt, self).create(vals)
